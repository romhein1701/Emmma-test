    ...
    <section id="capsules" className="em-capsules section">
      <div className="container">
        <div className="em-capsules-head">
          ...
          <div className="em-capsules-mode">
            <span className="mode-tab is-active">Carbon</span>
            <span className="mode-tab">Bone</span>
          </div>
        </div>
      ...
      <style>{`
        ...
        .em-h2 {
          ...
          letter-spacing: -0.045em; color: var(--fg); margin: 0;
        }
        .em-lede {
          font: 400 18px/1.55 var(--font-body); color: var(--fg-muted);
          letter-spacing: -0.005em; margin: 0;
        }
        .em-capsules-mode {
          display: inline-flex; padding: 4px; background: var(--surface-2);
          border: 1px solid var(--border); border-radius: var(--radius-sm);
        }
        .mode-tab {
          padding: 8px 14px; font: 500 13px/1 var(--font-ui); color: var(--fg-subtle);
          border-radius: 6px; cursor: pointer; user-select: none;
          transition: background-color var(--dur-fast), color var(--dur-fast);
        }
        .mode-tab.is-active { background: var(--surface); color: var(--fg); }
        .em-capsules-grid {
